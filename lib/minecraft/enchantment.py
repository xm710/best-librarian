...
def get_enchantment_data_by_namespace_name(namespace_name: str) -> Any:
    """
    取得附魔資料
    """
...
def get_max_price(level: int, is_treasure: bool) -> int:
    """
    取得附魔書交易綠寶石上限
    """
...
def get_min_price(level: int, is_treasure: bool) -> int:
    """
    取得附魔書交易綠寶石下限
    """
