...
class MainWindow(QWidget):
    ...
    def librarian_selector_combo_box_index_on_change(self):
        ...
        if (current_librarian := self.searchVillagerWidget.ui.librarianSelectorComboBox.currentData()):
            ...
            enchanted_book_recipes = self.services.librarian_service.get_enchanted_book_recipes(current_librarian)
            display_recipes = [
                self.services.librarian_service.build_display_recipe(recipe) for recipe in enchanted_book_recipes
            ]
